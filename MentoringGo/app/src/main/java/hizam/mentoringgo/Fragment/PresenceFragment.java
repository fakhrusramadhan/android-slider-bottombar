...
public class PresenceFragment extends Fragment {
    ...
    @BindView(R.id.bgPresence)
    ImageView bgBlur;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View viewPresence = inflater.inflate(R.layout.fragment_presence, container, false);

        ButterKnife.bind(this, viewPresence);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.presence);
